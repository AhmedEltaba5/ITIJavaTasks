 ...
 */
public class SparkLibTest {
    public static void main(String[] args) {
        // Create Spark Session to create connection to Spark
        final SparkSession sparkSession = SparkSession.builder ().appName ("AirBnb Analysis").master ("local[6]")
                .getOrCreate ();
        ...
        dataFrameReader.option ("header", "true");
         Dataset<Row> airbnbDF = dataFrameReader.csv ("listings.csv");
        ...
        airbnbDF.printSchema ();
        final Dataset<org.apache.spark.sql.Row> airbnbNoNullDF=airbnbDF.na().drop ();
        airbnbNoNullDF.printSchema ();
        System.out.println (airbnbDF.count ());
        System.out.println ("========================================================================");
        //Randomly Split the Dataset to 80 % Train Data and 20 % test Data
        double split[] = {0.8, 0.2};
        Dataset<org.apache.spark.sql.Row> airbnbDFArray[] = airbnbDF.randomSplit (split, 42);
        //Getting the Train Dataset
        Dataset<org.apache.spark.sql.Row> airbnbDFTrain = airbnbDFArray[0];
        ...
        Dataset<org.apache.spark.sql.Row> airbnbDFTest = airbnbDFArray[1];
        ...
        Dataset<org.apache.spark.sql.Row> airbnbDFTrainTransform = vectorAssembler.transform (airbnbDFTrain.na ().drop ());
        ...
        final Dataset<org.apache.spark.sql.Row> predictions = linearRegressionModel.transform(airbnbDFTest);
        predictions.show();
    }
